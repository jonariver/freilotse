    ...
    return (
      <LegalLayout title="Datenschutzerklärung" documentTitle={t("legal.datenschutz.documentTitle")} metaDescription={t("legal.datenschutz.metaDescription")}>
        ...
        <LegalSection title="6. Planung, Freigabelinks und Kalenderexport">
          ...
          <p>Bei ausreichend langen freien Zeiträumen zeigt der Urlaubsplaner zusätzlich die Schaltflächen „Flüge“ und „Unterkunft“ an. Ein Klick öffnet jeweils eine Auswahl zwischen zwei Anbietern – bei „Flüge“ zwischen Google Flights und Skyscanner, bei „Unterkunft“ zwischen Booking.com und Trip.com. Die dort angebotenen externen Links sind vorausgefüllt mit dem Datumsbereich des jeweiligen Zeitraums sowie – falls du sie freiwillig einträgst – deiner Zielort-Eingabe; bei den Flugportalen zusätzlich mit einem optionalen Abflughafen, der beim ersten Aufruf anhand deines gewählten Bundeslands beziehungsweise Kantons vorgeschlagen, aber jederzeit überschreibbar ist. Reiseziel- und Abflughafen-Feld werden nicht gespeichert und sind nicht Teil eines Freigabelinks. Beim bloßen Anzeigen dieser Schaltflächen beziehungsweise der Auswahl werden keine Daten übertragen. Erst wenn du einen der beiden Anbieter auswählst, verlässt du diese Website und dein Browser stellt eine Verbindung zum jeweiligen Anbieter her; dabei können personenbezogene Daten, insbesondere deine IP-Adresse, technische Verbindungsdaten sowie eine eingetragene Zielort- beziehungsweise Abflughafen-Angabe, verarbeitet werden. Für die weitere Datenverarbeitung auf der jeweiligen Website ist der jeweilige Anbieter verantwortlich. Weitere Informationen findest du in der <ExternalLegalLink href="https://policies.google.com/privacy?hl=de">Datenschutzerklärung von Google</ExternalLegalLink>, der <ExternalLegalLink href="https://www.skyscanner.de/media/privacy-policy">Datenschutzerklärung von Skyscanner</ExternalLegalLink>, der <ExternalLegalLink href="https://www.booking.com/content/privacy.html">Datenschutzerklärung von Booking.com</ExternalLegalLink> beziehungsweise der <ExternalLegalLink href="https://de.trip.com/contents/service-guideline/privacy-policy.html">Datenschutzerklärung von Trip.com</ExternalLegalLink>.</p>
          <p>Trip.com gehört zur Trip.com Group. Laut deren Datenschutzerklärung ist für die Verarbeitung deiner Daten die Trip.com Travel Singapore Pte. Ltd. mit Sitz in Singapur verantwortlich; eine Verarbeitung außerhalb der EU beziehungsweise des EWR, unter anderem in Singapur, ist damit möglich. Trip.com gibt an, hierfür unter anderem Standardvertragsklauseln zu verwenden.</p>
        </LegalSection>
        ...
        <LegalSection title="10. Cookies, lokale Speicherung und Netlify Web Analytics">
          <p>FREILOTSE speichert bestimmte Informationen ausschließlich lokal in deinem Browser (Local Storage), niemals auf einem Server: von dir gespeicherte Urlaubspläne, deine Statistik beim Brückentage-Rätsel (Streak, Spielverlauf) sowie deine gewählte Sprache. Beim Umschalten der Sprache kommt zusätzlich kurzzeitig Session Storage zum Einsatz, um deine noch ungespeicherten Eingaben über den dafür nötigen Neuladen der Seite hinweg zu erhalten; dieser Eintrag wird unmittelbar danach wieder gelöscht. Diese Speicherung ist technisch notwendig, um die von dir ausdrücklich genutzten Funktionen (etwa „Plan speichern" oder die Sprachumschaltung) überhaupt bereitstellen zu können, und erfolgt daher gemäß § 25 Abs. 2 Nr. 2 TDDDG ohne gesonderte Einwilligung. FREILOTSE setzt darüber hinaus keine eigenen Cookies ein, und es findet keine personalisierte Werbung oder Bildung individueller Nutzerprofile statt.</p>
